...
export const CHARACTERS = ['たまごっち', 'サンリオ', 'ディズニー', 'しずくちゃん', 'ちいかわ', '平成ファンシー'];
export const STICKER_TYPES = ['ボンボンドロップシール', 'プチドロップシール', 'ウォーターシール', 'おはじきシール', 'タイルシール', '平面シール'];
export const POST_TIMES = ['10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00'];
export const AREAS = ['新宿', '渋谷', '池袋', '原宿', '表参道', '銀座', '秋葉原', '上野', '浅草'];
export const PREFERRED_SHOPS = ['東急ハンズ', 'LOFT', 'ドンキホーテ', 'PLAZA', 'キデイランド', 'ビレッジバンガード'];
